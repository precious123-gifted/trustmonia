...
export default function TrustmoniaConnectSection() {
  return (
    <div className='bg-blue  text-center landscape:h-[70vw] portrait:h-[485vw] portrait:sm:h-[300vw] w-[100vw]  text-darkgreen flex justify-center items-center '>
...
<div className="steps text-[1.6vw]  portrait:text-[5vw]  portrait:sm:text-[3vw]  w-full h-[45%] portrait:h-[60%] flex landscape:justify-between  items-center  portrait:flex-col portrait:justify-between  ">
