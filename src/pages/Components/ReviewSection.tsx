...
<div className="cards-container text-[1.5vw]  portrait:text-[5vw]  portrait:sm:text-[3vw] font-manuale overflow-x-hidden w-full h-[70%] portrait:h-[50%]  portrait:sm:h-[50%] portrait:w-[100%]  flex justify-center portrait:justify-center items-center">
