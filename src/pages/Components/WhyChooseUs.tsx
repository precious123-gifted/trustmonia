...
export default function WhyChooseUs() {
  return (
    <div className='w-[100vw] landscape:h-[160vw] portrait:h-[380vw] portrait:sm:h-[245vw] bg-grey flex item-center justify-center pt-[6vw]  portrait:pt-[30vw] portrait:sm:pt-[20vw] '>
