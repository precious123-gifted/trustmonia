...
<div className="headerTXT   portrait:text-[200%]  font-[510] text-darkgreen  landscape:text-[350%] landscape:h-[70%]  landscape:mb-[9%]"><span>CONNECTING PEOPLE
WITH COMPANIES
...
<Image  alt='' src={headerIMG}   className='w-[97%] object-contain aspect-[4/3] landscape:object-right portrait:mb-[17%]  portrait:w-[150%] ' />


<div className="BTN text-[150%] landscape:hidden flex item-center justify-center">
    <span className=' transition-all ease-in duration-[0.5s] bg-armygreen hover:bg-blue hover:text-armygreen p-[13px] text-grey rounded cursor-pointer'>Company Review</span>
</div>
</div>
